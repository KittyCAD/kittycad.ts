...
export const testsExpectedToThrow = [
  ...
  'payments.set_default_payment_method_for_user',
  ...
  'payments.update_org_subscription_for_any_org',
  'payments.upsert_subscription_plan_price',
  ...
  'file.create_file_surface_area',
  'file.create_file_volume',
  'ml.create_kcl_code_completions',
  'orgs.search_org_dataset_conversions',
  'orgs.upload_org_dataset_files',
  'store.create_store_coupon',
  'unit.get_angle_unit_conversion',
  'unit.get_area_unit_conversion',
  'unit.get_current_unit_conversion',
  'unit.get_energy_unit_conversion',
  'unit.get_force_unit_conversion',
  'unit.get_frequency_unit_conversion',
  'unit.get_length_unit_conversion',
  'unit.get_mass_unit_conversion',
  'unit.get_pressure_unit_conversion',
  'unit.get_temperature_unit_conversion',
  'unit.get_torque_unit_conversion',
  'unit.get_volume_unit_conversion',
  'users.get_oauth2_providers_for_user',
  'users.get_user_self',
