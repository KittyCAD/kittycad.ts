 ...
 */
export default class ExecutorTerm {
  constructor() {}
   ...
   */
  static urlConstructFrom(functionNameParams: ExecutorTermParams): URL {
  ...
  static authenticate(functionNameParams: ExecutorTermParams, ws: WebSocket) {
  ...
  static toBSON(data: unknown): Uint8Array {
   ...
   */
  static parseMessage(ev: MessageEvent): unknown {
    ...
    if (typeof Buffer !== 'undefined' && Buffer.isBuffer?.(data)) {
      ...
      return BSON.deserialize(buf) as unknown as unknown
    }
    if (data instanceof ArrayBuffer) {
      ...
      return BSON.deserialize(bytes) as unknown as unknown
    }
