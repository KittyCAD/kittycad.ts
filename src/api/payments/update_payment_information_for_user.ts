...
interface UpdatePaymentInformationForUserParams {
  client?: Client;
  body: BillingInfo_type;
}

type UpdatePaymentInformationForUserReturn = Customer_type;

export default async function update_payment_information_for_user({
  client,
  body,
}: UpdatePaymentInformationForUserParams): Promise<UpdatePaymentInformationForUserReturn> {
