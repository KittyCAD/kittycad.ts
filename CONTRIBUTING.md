...
This specification is generated only after `api` gets those changes first.
It triggers a bot to commit the new specification to this repository.

**Every pushed tag is published to NPM. Make sure to bump the version before merging any PR!**
